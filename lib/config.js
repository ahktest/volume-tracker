...
module.exports = {
  ...
  // /v1/address/labels adres BAŞINA 1 çağrı. CANLI TESTTE 3/3 BOŞ (`data:{}`) döndü — BSC
  // cüzdanları için etiket üretmiyor. Coin başına 10 boş çağrı = boşa kredi + gecikme, o
  // yüzden 0 (kapalı). Başka zincirde işe yaradığı görülürse 10 yapmak yeterli.
  CHAINBASE_LABEL_TOP_N: 0,
