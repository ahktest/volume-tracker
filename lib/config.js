...
module.exports = {
  ...
  RSI_OVERSOLD:       30,   // kesişim bu değerin ÜZERİNDEyken olmalı (aşırı satımdan çıkış)
  RSI_CROSS_MAX_DAYS: 2,    // "son N gün içinde yukarı kesmiş" — Teknik Takip sekmesi filtresi

  // ── Hareketli ortalama (golden/death cross) ──
  MA_FAST:            50,    // hızlı SMA
  MA_SLOW:            200,   // yavaş SMA (golden cross = MA50 yukarı MA200'ü keser)
  MA_CROSS_RECENT_DAYS: 10,  // bu kadar gün içindeki kesişim "yeni" golden/death cross rozeti

  // ── MACD (klasik 12/26/9, EMA) ──
  MACD_FAST:          12,
  MACD_SLOW:          26,
  MACD_SIGNAL:        9,     // MACD çizgisi > sinyal (hist>0) = boğa; kesişim = al/sat sinyali
