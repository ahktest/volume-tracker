...
async function scanCoin(pool, coin) {
  ...
  // NOT: çoklu zaman dilimi teknik sinyalleri (coin_tech_signals) artık lib/techScan.js'te,
  // AYRI ve daha geniş bir evrende (tüm TRADING futures) hesaplanır. Burası alpha∩futures kalır.
