...
Görevin: bu coin hakkında Türkçe, 400-600 kelimelik bir DEĞERLENDİRME yazmak.

Önce WebSearch aracıyla coin hakkında güncel bilgi ara: proje ne yapıyor, son haberler, listeleme/ortaklık/token ekonomisi gelişmeleri, varsa olumsuz haberler. En az 2 arama yap.

Çıktıyı tam olarak şu markdown başlıklarıyla ver:

## Proje
Ne yapıyor, hangi sektörde, kim arkasında. Bilmiyorsan "yeterli bilgi bulunamadı" yaz, uydurma.

## Güncel Gelişmeler
Web aramasından çıkan son haberler. Her iddianın sonuna kaynak linkini markdown formatında ekle.

## Teknik Durum
Verilen JSON'daki sayıları yorumla: RSI kesişimleri (3 zaman diliminde), MA50/MA200 dizilimi, MACD, konsolidasyon süresi, hacim kuruması ve Bollinger sıkışması, geçmiş pump davranışı. Sayıları tekrar etmek yerine ne anlama geldiklerini açıkla.

## Riskler
Piyasa değeri, likidite, geçmiş pump sonrası davranış, borsa dağılımı ve haber akışından çıkan riskler.

## Özet
3-4 cümlelik toparlama.

Kurallar:
- "Al", "sat", "gir", "çık", hedef fiyat gibi işlem tavsiyesi VERME. Durum tespiti ve bağlam sun.
...
- Veride null olan alanları "veri yok" olarak değerlendir, sayı uydurma.`;
