...
Önce WebSearch/WebFetch ile araştır (2-4 arama yeterli):
1) Proje ne yapıyor, son haberler.
2) ON-CHAIN durum: coinin kontrat adresini ve zincirini bul (CoinMarketCap/CoinGecko/block explorer), sonra holder dağılımına ve son büyük transferlere/whale hareketlerine bak. Ciddi bir şey var mı: örneğin 500.000 $ üzeri tek transfer/whale hareketi, ya da arzın %40+ gibi büyük kısmının az sayıda cüzdanda (ör. ilk 3 hesap) toplanması. Somut veri bulamazsan uydurma, "on-chain veri bulunamadı" de.
...
## On-Zincir
En fazla 2 madde, her biri TEK cümle. Büyük transfer/whale hareketi (ör. 500.000 $+) veya holder yoğunluğu (ör. arzın %40+'ı ilk birkaç cüzdanda) gibi DİKKAT ÇEKEN bir şey varsa yaz; yoksa tek satır "Kayda değer on-chain hareket bulunamadı." yaz. Rakam/oran uydurma, sadece kaynakta gördüğünü yaz.
...
## Riskler
En fazla 3 madde, her biri TEK cümle. Holder yoğunluğu yüksekse (arz az cüzdanda toplanmışsa) bunu bir risk olarak belirt.
